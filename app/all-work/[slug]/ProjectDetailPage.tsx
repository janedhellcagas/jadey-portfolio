...
const PROJECTS: Record<string, any> = {
    ...
    "reviv":          { title:"Reviv",                           category:"UI/UX DESIGN",  client:"Reviv",           industry:"Health and Wellness, E-commerce",     services:"Website, UI/UX Design",                figmaUrl:"",        desc:"Oral health device landing page — premium, dark, with bold before/after storytelling and a money-back hook.",                             bg:"linear-gradient(135deg,#0A0A0A,#1A1000)", challenge:"Reviv needed a landing page that could clearly communicate a complex and unfamiliar product concept—positioning a wellness device as a solution for multiple health concerns such as TMJ, posture, fatigue, and cognitive function.\n\nThe challenge wasn’t just visual—it required building trust, educating users, and guiding them toward purchase within a single experience. Without a clear structure, users could easily feel skeptical or overwhelmed, leading to drop-offs before conversion.", solution:"I designed a conversion-driven landing page focused on clarity, trust, and guided storytelling.\n\nThe experience starts with a strong, benefit-led hero paired with before-and-after visuals to quickly establish relevance and credibility. From there, the page flows into structured, scannable sections that break down each benefit into simple, digestible insights—making complex claims easier to understand.\n\nTo reinforce trust, I integrated social proof, testimonials, guarantee messaging, and educational content, allowing users to validate the product at every step. The ‘What You Get’ and FAQ sections were intentionally placed to address objections before they become blockers, reducing friction in the decision-making process.\n\nVisually, the design uses a premium dark interface with gold accents to elevate perceived value and create a consistent, high-end feel aligned with the product positioning.", impact:"Improved content clarity, making complex health benefits easier to understand and trust • Increased engagement through a structured, scroll-based storytelling approach • Reduced potential drop-offs by proactively addressing user objections within the flow • Strengthened perceived product value through premium visual direction and layout consistency • Created a scalable landing structure that can support future campaigns, ads, and product variations", coverSrc:"/Reviv%20Landing%20Page%20Banner%20Showcase%20-%20Main.png", mockup1:"/Reviv%20Landing%20Page%20Banner%20Showcase%20-%20Main.png", mockup2:"/Reviv%20Landing%20Page%20Banner%20Showcase%20-%203rd.png", mockup3:"/Reviv%20Landing%20Page%20Banner%20Showcase%20-%204th.png", mockup4:"", mockup5:"", next:"scaleforge-uiux" },
    "scaleforge-uiux":{ title:"ScaleForge",                      category:"UI/UX DESIGN",  client:"ScaleForge",      industry:"Technology and Software and B2B Services", services:"UI/UX Design / Landing Page Design",  figmaUrl:"",        desc:"ScaleForge is a UI/UX design project focused on creating a clearer and more structured landing page experience for a technology and development-focused company. The goal was to present the company’s services, value, and digital product direction in a more organized and professional way.", bg:"linear-gradient(135deg,#100000,#2A0000)", challenge:"The landing page needed a stronger structure to explain the company’s services clearly. The content had to feel professional, easy to scan, and aligned with a technology-focused brand without overwhelming users.", approach:"Clear landing page structure • Strong content hierarchy • Clean section flow • Professional technology-focused layout • Responsive web design direction • User-friendly navigation and call-to-action placement • Consistent visual presentation across the page", solution:"Create a clean landing page layout with clearer content hierarchy, stronger section flow, and a more polished visual direction. The design should guide users through the company overview, services, value proposition, and call-to-action areas in a way that feels simple and credible.", impact:"The updated UI/UX direction helped make the ScaleForge landing page easier to understand, more organized, and better prepared for presenting the company’s services to potential clients or stakeholders.", coverSrc:"/ScaleForge%20Landing%20Page%20Banner%20Showcase%20-%20Main.png", mockup1:"/ScaleForge%20Landing%20Page%20Banner%20Showcase%20-%202nd.png", mockup2:"/ScaleForge%20Landing%20Page%20Banner%20Showcase%20-%203rd.png", mockup3:"/ScaleForge%20Landing%20Page%20Banner%20Showcase%20-%204th.png", mockup4:"", mockup5:"", next:"taskbeasts" },
