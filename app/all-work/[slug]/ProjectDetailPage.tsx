...
const PROJECTS: Record<string, any> = {
    ...
    "scaleforge":     { title:"ScaleForge",                      category:"UI/UX DESIGN",  client:"ScaleForge",      industry:"Technology Solutions / B2B",  services:"UI/UX Design, Website", figmaUrl:"",       desc:"Tech solutions company — scalable, reliable, metrics-driven, and rooted in strong company values.",                                      bg:"linear-gradient(135deg,#100000,#2A0000)", challenge:"ScaleForge, a company delivering scalable technology solutions for growing businesses, needed a landing page that communicated technical strength while also feeling human and values-driven — appealing to decision-makers who care about reliability, long-term partnership, and organizational culture.", solution:"Designed a bold dark page with red accent highlights and a powerful opening headline — 'Scalable technology solutions for growing businesses.' Key proof points (20+ integrations, 3x performance, 99.9% uptime) build immediate technical credibility. A company values section — Infinite Curiosity, Masterful Craftmanship, Adaptive Resilience, Relentless Innovation, Unwavering Integrity — positions ScaleForge as a principled, people-first technology partner.", impact:"The page effectively balances technical authority with cultural depth, giving ScaleForge a compelling digital front door that resonates with both technical evaluators and business decision-makers.", coverSrc:"/ScaleForge%20Landing%20Page%20Banner%20Showcase%20-%20Main.png", mockup1:"/ScaleForge%20Landing%20Page%20Banner%20Showcase%20-%202nd.png", mockup2:"/ScaleForge%20Landing%20Page%20Banner%20Showcase%20-%203rd.png", mockup3:"/ScaleForge%20Landing%20Page%20Banner%20Showcase%20-%204th.png", mockup4:"", mockup5:"", next:"starseekr" },
    "starseekr":      { title:"Starseekr",                       category:"UI/UX DESIGN",  client:"Starseekr",       industry:"HR & Recruitment",           services:"UI/UX Design, Website", figmaUrl:"",     desc:"Recruitment platform — helping businesses find their next star employee with expertise and precision.",                                   bg:"linear-gradient(135deg,#3B0090,#6600CC)", challenge:"Starseekr, a recruitment agency specializing in connecting businesses with top candidates, needed a landing page that felt modern and distinctive — standing apart from generic HR platforms while clearly communicating their thorough, client-focused approach to hiring.", solution:"Designed a vibrant purple-themed landing page anchored by the bold headline 'Helping You Find Your Next Star Employee.' A structured services grid — Expertise, Tailored Solutions, Precision, Exceptional Customer Service, and Passion — communicates the agency's comprehensive process. A geometric brand motif and office imagery reinforce the professional, results-oriented identity throughout.", impact:"The bold, distinctive purple design gives Starseekr a memorable brand presence in a crowded recruitment market, clearly communicating expertise and attracting new business clients.", coverSrc:"/Starseekr%20Landing%20Page%20Banner%20Showcase%20-%20Main.png", mockup1:"/Starseekr%20Landing%20Page%20Banner%20Showcase%20-%202nd.png", mockup2:"/Starseekr%20Landing%20Page%20Banner%20Showcase%20-%203rd.png", mockup3:"/Starseekr%20Landing%20Page%20Banner%20Showcase%20-%204th.png", mockup4:"", mockup5:"", next:"taskbeasts" },

    "taskbeasts":     { title:"TaskBeasts",                       category:"UI/UX DESIGN",  client:"TaskBeasts",      industry:"Outsourcing & Freelance Services", services:"UI/UX Design, Website",          figmaUrl:"",    desc:"Outsourcing platform — buy points, hand off tasks to vetted experts, and get results without the hassle of hiring freelancers.",  bg:"linear-gradient(135deg,#002A1A,#005A30)", challenge:"The outsourcing market is crowded — Fiverr, Upwork, Levy, Somewhere — and most platforms put the burden on the client: write a brief, vet applicants, manage the relationship. TaskBeasts had a genuinely different model. Instead of posting a job, clients buy points and hand tasks directly to vetted professionals. The platform handles the matching and delivery. The problem was the landing page wasn't communicating any of that. The headline was generic, the model wasn't explained, and there was nothing to distinguish TaskBeasts from the platforms it was built to replace.", solution:"I anchored the page around the core pitch: 'Outsource Anything.' The hero communicates the model in one clear line — 'Buy points, outsource tasks to vetted experts, and we handle the rest' — and immediately lowers the entry barrier with 'Try Your First 10 Points Free.' Below the fold, two distinct engagement models are laid out: hire a full-time professional in engineering or marketing for ongoing needs, or use points to pay per task for one-off work. A direct comparison section addresses the obvious question — why this over Fiverr or Upwork — head on. Navigation follows the decision journey: How It Works, Our Difference, Unique Value, Try Out For Free.", impact:"The page gives TaskBeasts a clear, differentiated pitch in a market where most platforms look and feel the same. First-time visitors understand the model quickly — what points are, how to use them, and why it's simpler than posting a job and vetting freelancers yourself. The free trial offer converts curiosity into a first transaction without asking visitors to commit upfront, giving the team a real funnel to build on.", coverSrc:"/TaskBeasts%20Banner%20Showcase%20-%20Main.png", mockup1:"/TaskBeasts%20Banner%20Showcase%20-%202nd.png", mockup2:"/TaskBeasts%20Banner%20Showcase%20-%203rd.png", mockup3:"", mockup4:"", mockup5:"", next:"helios-solar" },

    "helios-solar":   { title:"Helios Solar",                     category:"UI/UX DESIGN",  client:"Helios Solar",    industry:"Residential Solar Energy", services:"UI/UX Design, Web Platform",      figmaUrl:"",    desc:"Philippines' no.1 solar marketplace — panel options, savings calculator, bank financing, and admin tools in one platform.", bg:"linear-gradient(135deg,#2A1A00,#5A3800)", challenge:"Going solar in the Philippines involves more steps than most homeowners expect. Research panel brands separately. Find an installer separately. Figure out financing separately. For a purchase this significant, that fragmented process is a serious barrier. Helios Solar needed a platform that brought all of it together — panel selection, savings calculation, and bank financing — in one place, under one brand, so that a homeowner could go from curious to committed without leaving the site.", solution:"I designed a multi-page platform built around the homeowner's actual journey. The Marketplace Portal leads with 'Zero Down Solar' — no upfront costs, no hidden fees, easy installments — and surfaces panel options, location-based availability, and a live savings calculator that makes the value tangible (₱3.4M in projected savings over 25 years). The Finance Page connects visitors to bank partners — BPI, DBP, RCBC, and others — with a guided 5-step process and an interactive loan calculator. The Solar Calculator walks users through their electricity bill, roof type, and personal details to output a recommended system size and monthly cost impact. An Admin Dashboard rounds out the platform, giving the Helios Solar team tools to manage panels, inverters, installers, and customer orders in one place.", impact:"Helios Solar now has a platform that handles the full buyer journey — from first visit to financing approval — without sending users elsewhere at any step. The savings calculator and financing tools address the two biggest objections to going solar (cost and complexity) before a visitor has to speak to anyone. With 945+ customers in the system, the admin tools give the operations team real visibility into orders and active installations, making the business easier to run as it scales.", coverSrc:"/Helios%20Solar%20Site%20Banner%20Showcase%20-%20Main.png", mockup1:"/Helios%20Solar%20Site%20Banner%20Showcase%20-%202nd.png", mockup2:"/Helios%20Solar%20Site%20Banner%20Showcase%20-%203rd.png", mockup3:"/Helios%20Solar%20Site%20Banner%20Showcase%20-%204th.png", mockup4:"/Helios%20Solar%20Site%20Banner%20Showcase%20-%205th.png", mockup5:"/Helios%20Solar%20Site%20Banner%20Showcase%20-%206th.png", next:"ballers-ph" },

    "ballers-ph":     { title:"Ballers.ph",                       category:"UI/UX DESIGN",  client:"Ballers.ph",      industry:"Sports Media & Basketball News",    services:"UI/UX Design Improvement, Website", figmaUrl:"", desc:"Philippine basketball news site redesign — cleaner editorial hierarchy, improved article layouts, and responsive design across devices.", bg:"linear-gradient(135deg,#001A2A,#003A5A)", challenge:"Ballers.ph is where the Philippine basketball community goes for PBA and NBA coverage — game previews, featured articles, and Ballerspedia, an encyclopedia of Filipino basketball players. The site had an engaged audience and solid content, but the design had accumulated the usual issues: feature articles competing visually with sidebar items, too many elements at the same visual weight, and cards where the article title and context got buried in the layout. On mobile — where a significant portion of the community browses between plays and during commutes — the experience needed work. The brief was clear: improve what's broken without disrupting what users are already comfortable with.", solution:"I treated this as an editorial design improvement, not a rebuild. The navigation — Home, Features, Game Previews, Ballerspedia, About Us — stayed intact. The main work was establishing clear visual hierarchy across all article listings: a dominant full-width hero article at the top, a supporting grid of three preview cards beneath, and consistent card patterns across section pages (NBA Previews, PBA Previews, Featured Articles). The Ballerspedia section and sidebar got cleaner layouts with better separation between editorial content and newsletter or ad placements. Mobile views were tightened — stacked article cards and reduced visual noise so readers get to the content they came for.", impact:"The redesign makes Ballers.ph noticeably easier to scan — especially during active game days when the community is checking for the latest PBA or NBA preview before tipoff. Cleaner card hierarchy surfaces editorial content more effectively, so the right story gets seen at the right visual weight. Mobile usability improved across the board, reaching the portion of the audience that checks scores and previews on their phones. The client got targeted improvements — not a rebuild — that made the product better without requiring their audience to relearn the site.", coverSrc:"/Ballers.ph%20Site%20Banner%20Showcase%20-%20Main.png", mockup1:"/Ballers.ph%20Site%20Banner%20Showcase%20-%202nd.png", mockup2:"/Ballers.ph%20Site%20Banner%20Showcase%20-%203rd.png", mockup3:"/Ballers.ph%20Site%20Banner%20Showcase%20-%204th.png", mockup4:"", mockup5:"", next:"landing-page-kit" },

    "landing-page-kit": { title:"Landing Page Template Kit",      category:"TEMPLATE KIT",  client:"Figma Community", industry:"Design Resources",                 services:"UI/UX Design, Template Kit",        figmaUrl:"https://www.figma.com/community/file/1257872231846009966", desc:"Free Figma landing page kit — 30+ modular sections across web, mobile, and tablet, built to be adapted quickly across different products and industries.", bg:"linear-gradient(135deg,#1A0A2A,#3A1A5A)", challenge:"Every landing page project tends to start the same way — a blank file, a basic grid, and rebuilding the same patterns from scratch: a hero, a features block, a team section, a CTA. For freelancers and small teams, that repetition eats time that should go toward the actual design decisions that matter. I wanted to build a kit that genuinely shortened that cycle — not a rigid template locked into one aesthetic, but a set of modular sections flexible enough to adapt to different products without a full rebuild each time.", solution:"I built a structured set of landing page sections covering the patterns designers encounter most often: hero blocks in multiple layout variants, feature grids, team sections with member cards, contact forms, resources libraries, testimonial layouts, pricing tables, and FAQ blocks. Each section works standalone or as part of a larger page, held together by a consistent spacing system and type hierarchy. The kit ships across three responsive breakpoints — 30+ web sections, 30+ mobile sections, and 30+ tablet sections — with clear layer naming so editing is fast, not just dropping-in fast.", impact:"The kit has been used by thousands of designers through Figma Community. The consistent feedback is that it cuts down the setup phase without locking you into a specific look — designers take what they need and build from there. For freelancers handling multiple clients, the time saving compounds across projects. It also serves as a practical reference for designers learning how to structure landing pages across breakpoints: not just a file to download, but a working example of how sections fit together.", coverSrc:"/Landing%20Page%20Template%20Kit%20-%20Main.png", mockup1:"/Landing%20Page%20Template%20Kit%20-%202nd.png", mockup2:"/Landing%20Page%20Template%20Kit%20-%203rd.png", mockup3:"/Landing%20Page%20Template%20Kit%20-%204th.png", mockup4:"", mockup5:"", next:"advante" },
}
